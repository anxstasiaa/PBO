...
namespace Project_PBO
{
    ...
    {
        public string IDSemester { get; set; } //20241,20242, dsb
        ...
        public Semester()
        {
            IDSemester = string.Empty;
            namaSemester = string.Empty;
            TahunAjaran = string.Empty;
        }
        public void InputSemester()
        {
            Console.WriteLine($"Semester {namaSemester} dengan kode {IDSemester} dan tahun ajaran {TahunAjaran}");
        }
    }
}
